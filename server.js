...
<div class="checkbox-section">
  ...
  <div id="announcement-options" class="checkbox-suboptions" style="display: none;">
    <label><input type="checkbox" id="notify-email" checked> Email</label>
    <label><input type="checkbox" id="notify-text" checked> Text</label>
  </div>
</div>
...
<div class="checkbox-section">
  ...
  <div id="shipping-options" class="checkbox-suboptions">
    <label><input type="checkbox" id="ship-email" checked> Email</label>
    <label><input type="checkbox" id="ship-text"> Text</label>
  </div>
</div>
  ...
  <script>
    ...
    async function handleGoogleLogin(response) {
      ...
      try {
        ...
        document.getElementById('last-name').value = decoded.family_name || '';// server.js
